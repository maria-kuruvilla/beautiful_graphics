...
#By Trevor A. Branch tbranch@uw.edu Jan 2020, with reliance on lecture
#notes from Allan Hicks and Elizabeth Ng. 
...
map <- autoplot(bathy, geom=c('raster', 'contour'),
...
wa_terrain <- get_map(location = wa_bbox, source = 'google', 
                      maptype = 'terrain')
ggmap(wa_terrain) + 
